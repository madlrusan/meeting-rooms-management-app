...
import { CardText, MeetingCard, TextContainer } from "../../components/MainScreenComponents/ScheduleCards.components";
        ...
        <ScrollView>
            {EventsTimeIntervals.map((timeInterval, key) => {
                ...
                <MeetingCard key={key}>
                    ...
                    <CardText>{timeInterval.startTime} - {timeInterval.endTime}</CardText>
                    </TextContainer>
                    <CardText status={`${StatusTypes.Reserved.toLowerCase()}`}>Status</CardText>
                </MeetingCard>
                )
            })}
        </ScrollView>
